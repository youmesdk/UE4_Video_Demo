 ...
 * 
 */
class YOUMEVIDEO_API FYoumeVideoTextureResource
...
public:
	 ...
	 */
	FYoumeVideoTextureResource(UYoumeVideoTexture& InOwner, FIntPoint& InOwnerDim, SIZE_T& InOwnerSize, FLinearColor InClearColor, FGuid InTextureGuid);

	/** Virtual destructor. */
	virtual ~FYoumeVideoTextureResource() { }
